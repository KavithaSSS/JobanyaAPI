...
exports.Invitedlist = function (logparams,req, callback) {
    try {
        logger.info("Invited List : UserId: " + logparams.usercode + ", Originator: " + logparams.orginator + ", DeviceIP: " + logparams.ipaddress + ", Logdate: " + logparams.logdate + ", Type: " + logparams.type);
        ...
        logger.error("Error in Invited List - Employer " + e);
    }
}