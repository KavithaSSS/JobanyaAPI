...
exports.SendOTP = function (
  ...
  try {
    logger.info(
      "Log in Checking Send OTP: UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    objUtilities.GenerateRandamNo(function (validotp) {
      ...
      if (req.query.typecode == varconstant.forgetpwdtypecode) {
        messagecontent =
          "We have received a request for Forgot Password." +
          validotp +
          " is your OTP for your Forgot Password Request.";
      } else if (req.query.typecode == varconstant.changeemailtypecode) {
        messagecontent =
          "We have received a request to change the registered Email Id. " +
          validotp +
          " is the OTP to change your Email Id.";
      } else if (req.query.typecode == varconstant.invisiblemodetypecode) {
        messagecontent =
          "We have received a request to activate your bestjob account. " +
          validotp +
          " is the OTP to activate your account.";
      } else if (
        req.query.typecode == varconstant.verify_employer_email_typecode
      ) {
        messagecontent =
          "We have received a request for registration with Jobanya. " +
          validotp +
      ...
      var body_html =
        ...
        '<img src="' +
        varemailconstant.bestjobs_logo +
        '"/><br><br>' +
        ...
        varemailconstant.forgot_password +
        '"/>&nbsp;&nbsp;&nbsp;' +
        ...
        "Do you have a question ? Contact <a href=" +
        varemailconstant.bestjobs_link +
        ">JOBANYA Support</a> Team" +
        "</font></label>" +
        "<br><br>" +
        "<a href=" +
        varemailconstant.fb_link +
        ' target="_blank"><img style="height: 30px;" src="' +
        varemailconstant.fb_logo +
        '"/></a>&nbsp;&nbsp;&nbsp;' +
        ...
        "<a href=" +
        varemailconstant.youtube_link +
        ' target="_blank"><img style="height: 30px;" src="' +
        varemailconstant.youtube_logo +
        '"/></a>&nbsp;&nbsp;&nbsp;' +
        "<a href=" +
        varemailconstant.telegram_emplr_link +
        ' target="_blank"><img style="height: 30px;" src="' +
        varemailconstant.telegram_logo +
        '"/></a>' +
        "</center>" +
        "<br>" +
      ...
      dbo
        .collection(MongoDB.ControlsCollectionName)
        .find()
...
exports.CheckValidMailNameExists = function (logparams, req, callback) {
  try {
    var finalresult;
    logger.info(
      "Log in Checking Employer Email Id : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    const dbo = MongoDB.getDB();
    dbo
      .collection(MongoDB.EmployerCollectionName)
      .find(
        {
          registered_email: {
            $regex: "^" + req.query.registered_email + "$",
            $options: "i",
          },
        },
        { projection: { _id: 0, registeredname: 1 } }
      )
      .toArray(function (
        err,
        employerres //find if a value exists
      ) {
        ////console.log(employerres);
        return callback(employerres);
      });
  } catch (e) {
    logger.error("Error in checking Employer Email Id: " + e);
  }
};
...
exports.InsertOTPDetails = function (logparams, params, callback) {
  try {
    var finalresult;
    logger.info(
      "Log in Insert OTP Details : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    const dbo = MongoDB.getDB();
    dbo
      .collection(MongoDB.OTPDetailsCollectionName)
      .insertOne(params, function (err, result) {
        if (err) throw err;
        return callback(result.insertedCount);
      });
  } catch (e) {
    logger.error("Error in Insert OTP Details: " + e);
  }
};
exports.RegistrationMail = function (
  logparams,
  registered_email,
  adminmailid,
  employercode,
  ...
  try {
    logger.info(
      "Log in Registration Mail : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<a href=" +
              varemailconstant.Employer_portal_link +
              ">Login Now</a> and Set Your My Employee Preferences" +
              "<br><br>" +
              "</div>" +
              "<center>" +
              '<img style="height: 40px; width:200px" src="' +
              varemailconstant.welcome_mail +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.EmployerApprovedMail = function (
  registered_email,
  adminmailid,
  employercode,
  logparams,
  ...
  try {
    ...
    var subject = "Your JOBANYA Application has been approved";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.approve_employer +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 22px;"><font Style="color:black;">' +
              "<a href=" +
              varemailconstant.Employer_portal_link +
              ">Login Now</a> and Set Your Preferences" +
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
              "Do you have a question ? Contact <a href=" +
              varemailconstant.bestjobs_link +
...
exports.EmployerRejectedMail = function (
  registered_email,
  adminmailid,
  employercode,
  logparams,
  ...
  try {
    ...
    var subject = "Your JOBANYA Application has been rejected.";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.reject_employer +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.AppliedMail = function (
  ...
  try {
    ...
    var subject = "New Application received";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    ...
    objUtilities.getEmployerName(employercode, function (employerdetails) {
      if (employerdetails != null && employerdetails.length > 0) {
        ...
        else jobTitle = jobdetails.jobfunctionname;
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "</font></label>" +
              '<br><br><label style="font-size: 22px;"><font Style="color:black;">' +
              "You have received an application for <b> " +
              jobTitle +
              "</b> from <b>" +
              employeedetails.personalinfo.employeefullname +
              "</b>.</font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.apply_job +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.InvitedMail = function (
  ...
  try {
    ...
    var subject = "Invitation accepted";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "</font></label>" +
              '<br><br><label style="font-size: 22px;"><font Style="color:black;">' +
              "Your invitation to <b> " +
              employeedetails.personalinfo.employeefullname +
              "</b> for  <b>" +
              jobTitle +
              "</b> has been accepted by the employee.</font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.accept_employee +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
            ...
            objsendsms.GetSMSCount(logparams, function (smscount) {
              if (smscount != null && smscount.length > 1) {
                if (Number(smscount[1] > 0)) {
                  var messagecontent = varsmsconstant.employee_shortlisted
                    .replace(
                      varsmsconstant.employee_replace_name,
                      employeedetails.personalinfo.employeefullname
                    )
                    .replace(varsmsconstant.job_post, jobTitle)
                    .replace(varsmsconstant.employer, registeredName);
                  ////console.log("messagecontent", messagecontent);
                  objsendsms.SendCommonSMS(
                    logparams,
                    messagecontent,
                    employeedetails.contactinfo.mobileno,
                    varsmsconstant.employee_shortlisted_template,
...
exports.VerificationMail = function (
  logparams,
  registered_email,
  adminmailid,
  employercode,
  ...
  try {
    logger.info(
      "Log in Verification Mail : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
      ...
      if (employerdetails != null && employerdetails.length > 0) {
        ...
        dbo
          ...
          .toArray(function (err, result) {
            ...
            objUtilities.encryptemployerdetails(
              logparams,
              employercode + "~" + registered_email,
              async function (employerdetailsencrypt) {
                var $generatepath =
                  result[0].verification_link +
                  "?typecode=" +
                  typecode +
                  "&employercode=" +
                  employerdetailsencrypt;
                var body_html =
                  "<html>" +
                  "<head>" +
                  '<link href="http://fonts.googleapis.com/css?family=Salsa" rel="stylesheet" type="text/css">' +
                  ...
                  '<a href="' +
                  $generatepath +
                  '" target="_blank" style="border-color: #F59722!important; border-radius:8px; background: #F59722!important;color: #00141f;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px; font-weight:bold">Agree & Confirm your email</a>' +
                  "<br><br>" +
                  '<label style="font-size: 12px;"><font Style="color:black;">' +
                  ...
                  "<br><br>" +
                  '<label style="font-size: 12px;"><font Style="color:black;">' +
                  "Did Not Register @ JOBANYA ? Contact <a href=" +
                  varemailconstant.bestjobs_link +
                  ">JOBANYA Support</a> Team" +
                  "</font></label>" +
                  "<br><br>" +
...
exports.VerificationMail_NewEmail = function (
  logparams,
  registered_email,
  adminmailid,
  employercode,
            ...
            objUtilities.encryptemployerdetails(
              ...
              async function (employerdetailsencrypt) {
                ...
                var body_html =
                  ...
                  "<a href=" +
                  $generatepath +
                  ' target="_blank"><img style="height: 250px;" src="' +
                  varemailconstant.verification_mail +
                  '"/></a>&nbsp;&nbsp;&nbsp;' +
                  //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
                  "<br><br>" +
                  '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.JobPostSubmission = function (
  logparams,
  employercode,
  jobdetails,
  adminmailid,
  ...
  try {
    logger.info(
      "Log in Job Post Approval : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    var subject = "Job post is submitted successfully";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "Your job post <b> " +
              jobTitle +
              "</b> has been successfully submitted for approval.</font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.save_jobpost +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.JobPostApproval = function (
  logparams,
  employercode,
  jobdetails,
  adminmailid,
  ...
  try {
    logger.info(
      "Log in Job Post Submission : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    var subject = "Your Job Post has been approved.";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "</b> with <b>" +
              jobdetails.jobid +
              "</b> is approved and live now.</font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.approve_jobpost +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.JobPostRejected = function (
  logparams,
  employercode,
  jobdetails,
  adminmailid,
  ...
  try {
    logger.info(
      "Log in Job Post Rejected : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    var subject = "Your Job Post has been rejected";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "Your job post " +
              jobTitle +
              " has been rejected and has not been posted.</font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.reject_jobpost +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.SubscriptionSuccess = function (
  logparams,
  employermailid,
  adminmailid,
  employercode,
  ...
  try {
    logger.info(
      "Log in Job Package Subscription : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    var subject = "Your Subscription is successful";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              " is Successful.</font></label>" +
              '<br><label style="font-size: 22px;"><font Style="color:black;">' +
              "The reference number is " +
              subscriptiondetails.razorpay_order_id +
              ". </font></label>" +
              '<br><label style="font-size: 22px;"><font Style="color:black;">' +
              ...
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.success_subscription +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.SubscriptionFailure = function (
  logparams,
  employermailid,
  adminmailid,
  employercode,
  ...
  try {
    logger.info(
      "Log in SubscriptionFailure : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    var subject = "Your Subscription has failed";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
...
exports.SubscriptionExpired = function (
  logparams,
  subscriptiondetails,
  adminmailid,
  employercode,
  ...
  try {
    logger.info(
      "Log in Job Package Expired : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.expiring_subscription +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.AbuseEmployee = function (
  tomailid,
  employercode,
  logparams,
  adminmailid,
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<b>" +
              employeedetails.personalinfo.employeefullname +
              "</b> has reported abuse on " +
              jobTitle +
              " with " +
              registeredName +
              ". Please take necessary action.</font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.abuse_employee +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
              ...
              '"/></a>&nbsp;&nbsp;&nbsp;' +
              "<a href=" +
              varemailconstant.telegram_emp_link +
              ' target="_blank"><img style="height: 30px;" src="' +
              varemailconstant.telegram_logo +
              '"/></a>' +
              "</center>" +
...
exports.AbuseEmployer = function (
  tomailid,
  employercode,
  logparams,
  adminmailid,
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.abuse_employer +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.AbuseEmployerReply = function (
  employercode,
  logparams,
  adminmailid,
  employeedetails,
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              ",</font></label>" +
              '<br><br><label style="font-size: 22px;"><font Style="color:black;">' +
              "Thanks for reporting abuse on " +
              employeedetails.personalinfo.employeefullname +
              ". We will take necessary action.</font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
              '<img style="height: 250px;" src="' +
            ...
            let mailOptions = {
              from: "noreply@jobanya.com",
              to: String(employerdetails[0].registered_email),
              subject: subject,
              text: body_text,
              html: body_html,
              // Custom headers for configuration set and message tags.
...
exports.ContactUsEmployee = function (
  logparams,
  employeemailid,
  adminmailid,
  employeedetails,
  ...
  try {
    logger.info(
      "Log in ContactUsEmployee : UserId: " +
        logparams.usercode +
        ", Originator: " +
        logparams.orginator +
        ", DeviceIP: " +
    ...
    var subject = "Thanks for your valuable feedback and remarks";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
    ...
    dbo
      ...
      .toArray(async function (err, result) {
        ...
        var body_html =
          ...
          "<center>" +
          '<img style="height: 250px;" src="' +
          varemailconstant.employee_feedback +
          '"/>&nbsp;&nbsp;&nbsp;' +
          //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
          "<br><br>" +
          '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.ContactUsEmployer = function (
  logparams,
  employercode,
  adminmailid,
  callback
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<center>" +
              '<img style="height: 250px;" src="' +
              varemailconstant.employer_feedback +
              '"/>&nbsp;&nbsp;&nbsp;' +
              //'<a href="'+$generatepath+'" target="_blank" style="cursor:pointer;"><button style="border-color: #ffa500!important;background: #ffa500!important;color: white;padding: 7px 23px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">Agree & Confirm your email</button></a>'+
              "<br><br>" +
              '<label style="font-size: 12px;"><font Style="color:black;">' +
...
exports.SubscriptionContactusMail = function (
  employercode,
  registered_email,
  supportmailid,
  adminmailid,
  ...
  try {
    ...
    var subject = "New job package request";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    var body_text = "";
    const dbo = MongoDB.getDB();
        ...
        dbo
          ...
          .toArray(async function (err, result) {
            ...
            var body_html =
              ...
              "<b>" +
              registeredName +
              "</b> contact you for new job package request. <br><br> " +
              "No. of posts: " +
              contactusparams.noofposts +
              "<br>No. of profile: " +
              contactusparams.noofprofile +
              "<br>No. of vacancies: " +
              contactusparams.noofvacancies +
              "<br>Description: " +
              contactusparams.description +
              "<br><br></font></label>" +
              "</div>" +
              "<br>" +
              "<center>" +
...
exports.DeactivateEmployee = function (
  logparams,
  employeemailid,
  adminmailid,
  employeedetails,
...
exports.DeactivateEmployer = function (
  employercode,
  registered_email,
  adminmailid,
  logparams,
...
exports.EmailToEmployer = function (
  logparams,
  Subject,
  Content,
  registered_email,
...
exports.EmployeeEmailVerificationWithOTP = function (
  logparams,
  registeredName,
  adminmailid,
  req,
...
exports.CheckEmployeeMailNameExists = function (logparams, req, callback) {
  try {
    ...
    var dbCollectionName =
      Number(req.query.isleadtype) == 0
        ? MongoDB.EmployeeCollectionName
        : MongoDB.LeadCollectionName;
    dbo
      .collection(String(dbCollectionName))
      .aggregate([
...
exports.SendSMTPOTP = function (
  ...
  try {
    ...
    var configurationSet = "ConfigSet";
    // console.log(process.env.SMTPENDPOINT);
    const smtpEndpoint = process.env.SMTPENDPOINT;
    const port = process.env.SMTPPORT;
    const smtpUsername = process.env.SMTPUSERNAME;
    const smtpPassword = process.env.SMTPPASSWORD;
    ...
    var subject = "OTP Verification for Registration with Jobanya";
    var tag0 = "key0=value0";
    var tag1 = "key1=value1";
    // The email body for recipients with non-HTML email clients.
    var body_text = "";
