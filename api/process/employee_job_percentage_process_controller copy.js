...
exports.UpdateMatchingPercentage = function (jobresult, employeelist, jobpercentage, callback) {
    try {

        UpdateMatchingPercentageToEmployee(jobresult, employeelist, jobpercentage, function (err, employeecount) {
            if (err) {
                return;
            }
...
function UpdateMatchingPercentageToEmployee(jobresult, employeelist, jobpercentage, callback) {
    try {
        var returnval;
        var iteratorFcn = function (employee, done) {
            ...
            exports.UpdateMatchingPercentage_Employee(employee, jobresult, jobpercentage,  function (response) {
                returnval = response;
                done();
                return;
            });
...
exports.UpdateMatchingPercentage_Employee = function (employeecodevalue, jobresult, jobpercentage, callback) {
    try {         
        objUtilities.getemployeedetails(employeecodevalue.employeecode, function (employee) {
            if (employee != null && employee.length > 0) {      
                exports.CalcAndUpdatePercentage(employeecodevalue.employeecode, jobresult, jobpercentage,  function (response) {
...
exports.CalcAndUpdatePercentage = function (employeecode, jobresult, jobpercentage,  callback) {
    try {         
        //console.log("jobresult",jobresult)
        objUtilities.getemployeedetails(employeecode, function (employee) {
            if (employee != null && employee.length > 0) {    
                ...
                //     if (err) throw err;
                    objUtilities.getcurrentmilliseconds(function (currenttime) {
                        ...
                        var insertparams = {"employeecode":employeecode, "jobcode":jobresult[0].jobcode, "matchpercentage":totalPercentage,"createddate":currenttime}              
