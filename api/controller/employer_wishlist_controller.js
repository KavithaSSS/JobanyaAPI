...
exports.WishlistList = async function (req, res) {
    try {
      ...
      if (!decoded) {
        ...
        objUtilities.CheckValidUserOrEmployeeOrEmployer(req, function (validemp) {
            if (validemp == true) {
                ...
                var objLogdetails;
                const logvalues = { ipaddress: req.query.ipaddress, usercode: req.query.employercode, orginator: 'Wishlist List', logdate: new Date(), type: logType }
                ...
                else
                {
                  ...
                  //var empparams = {"jobcode": req.query.jobcode};
                   ...
                   // //console.log("job", langparams);
                      ...
                      objProfileList.getAllProfiles(logparams, langparams, listparams,5, 0, 1, function (profilelistresult) {
        ...
        logger.error("Error in Wishlist in employer : " + e);
    }
}
