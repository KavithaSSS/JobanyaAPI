...
exports.getJobFilterBind = async function (req, res) {
  try {
    ...
    var params = {
      ipaddress: req.query.deviceip,
      usercode: logUserCode,
      orginator: "Job Filter",
      type: logType,
    };
    // //console.log(params);
    ...
    objUtilities.Checkvalidfilteraccessuser(req, function (validemp) {
      if (validemp == true || Number(req.query.employeecode) == -1) {
        ...
        //Skills
          ...
          // //console.log("Entry");
          objSkillFilter.getSkillFilterBind(
            logparams,
            empparams,
            function (skillresult) {
              ...
              if (skillresult != null && skillresult.length > 0) {
                ...
                const msgparam = {
                  messagecode: varconstant.recordnotfoundcode,
                };
                objUtilities.getMessageDetailWithkeys(
                  msgparam,
                  function (msgtext) {
          ...
          //Location
          // //console.log("Entry");
          objLocationFilter.getLocationFilterBind(
            logparams,
            empparams,
          ...
          //Job Function
          // //console.log("Entry");
          objJobFunctionFilter.getJobFunctionFilterBind(
            logparams,
            empparams,
            function (jobfunctionresult) {
              ////console.log(jobfunctionresult);
        ...
        } else if (Number(req.query.type) == 4) {
          //Job Type
          // //console.log("Entry");
          objJobtypeFilter.getJobTypeFilterBind(
            logparams,
            empparams,
            function (jobtyperesult) {
              ////console.log(jobfunctionresult);
        ...
        } else if (Number(req.query.type) == 5) {
          //Education
          // //console.log("Entry");
          objEducationFilter.getEducationFilterBind(
            logparams,
            empparams,
                    ...
                    return res.status(200).json({
                      education_filter_json_result: {
                        ...
                        educationcategorylist:
                          educationresult.educationcategorylist,
                        schoolinglist: educationresult.schoolinglist,
                        afterschoolinglist: educationresult.afterschoolinglist,
                      },
                    });
          ...
          //Experience
          // //console.log("Entry");
          objExperienceFilter.getExperienceFilterBind(
            logparams,
            empparams,
        ...
        } else if (Number(req.query.type) == 7) {
          //Industry
          // //console.log("Entry");
          objIndustryFilter.getIndustryFilterBind(
            logparams,
            empparams,
          ...
          //Employer Type
          // //console.log("Entry");
          objEmployerTypeFilter.getEmpTypeFilterBind(
            logparams,
            empparams,
            function (emptyperesult) {
              ////console.log(jobfunctionresult);
        ...
        } else if (Number(req.query.type) == 9) {
          //Company Type
          // //console.log("Entry");
          objCompanyTypeFilter.getCompanyTypeFilterBind(
            logparams,
            empparams,
            function (companytyperesult) {
              ////console.log(jobfunctionresult);
        ...
        } else if (Number(req.query.type) == 10) {
          //Job Group
          // //console.log("Entry");
          objJobGroupFilter.getJobGroupFilterBind(
            logparams,
            empparams,
            function (jobgroupresult) {
              ////console.log(jobfunctionresult);
              if (jobgroupresult != null) {
                //return res.status(200).json({
                const msgparam = { messagecode: varconstant.listcode };
        ...
        } else if (Number(req.query.type) == 11) {
          //Job Role
          // //console.log("Entry");
          objJobRoleFilter.getJobRoleFilterBind(logparams, empparams, function (jobroleresult) {
            ////console.log(jobfunctionresult);
    ...
    logger.error("Error in Filter Bind: " + e);
  }
};

exports.getProfileJobFilterBind = async function (req, res) {
  try {
    const decoded = await objUtilities.validateToken(req);
    if (!decoded) {
      return res.status(200).json({
    ...
    objUtilities.checkvalidemployee(
      ...
      function (validemp) {
        if (validemp == true) {
          ...
          var params = {
            ipaddress: req.query.deviceip,
            usercode: logUserCode,
            orginator: "Profile Job Filter Bind",
            type: logType,
          };
          objUtilities.getLogDetails(params, function (logresponse) {
            objLogdetails = logresponse;
          ...
          ////console.log(req.query.type)
          if (Number(req.query.type) == 0) {
            objSkillFilter.getProfileSkillFilterBind(
              logparams,
              empparams,
              function (skillresult) {
                if (skillresult != null) {
                  // console.log("Skill");
                  objLocationFilter.getProfileLocationFilterBind(
                    logparams,
                    empparams,
                    function (locationresult) {
                      if (locationresult != null) {
                        // console.log(locationresult)
                        objJobFunctionFilter.getProfileJobFunctionFilterBind(
                          logparams,
                          empparams,
                          function (jobfunctionresult) {
                            if (jobfunctionresult != null) {
                              // //console.log(jobfunctionresult)
                              objJobtypeFilter.getProfileJobTypeFilterBind(
                                logparams,
                                empparams,
                                function (jobtyperesult) {
                                  if (jobtyperesult != null) {
                                    // //console.log(jobtyperesult)
                                    objEducationFilter.getProfileEducationFilterBind(
                                      logparams,
                                      empparams,
                                      function (educationresult) {
                                        if (educationresult != null) {
                                          // //console.log(educationresult)
                                          objExperienceFilter.getProfileExperienceFilterBind(
                                            logparams,
                                            empparams,
                                            function (experienceresult) {
                                              if (experienceresult != null) {
                                                            ...
                                                            objCompanyTypeFilter.getCompanyTypeFilterBind(
                                                              ...
                                                              function (
                                                                ...
                                                                if (
                                                                  ...
                                                                  objJobGroupFilter.getProfileJobGroupFilterBind(
                                                                    logparams,
                                                                    empparams,
                                                                    function (
                                                                      jobgroupresult
                                                                      ...
                                                                      if (
                                                                        ...
                                                                        if (
                                                                          (locationresult.districtlist &&
                                                                            locationresult
                                                                              .districtlist
                                                                              .length ==
                                                                              0) ||
                                                                          (locationresult.taluklist &&
                                                                            locationresult
                                                                              .taluklist
                                                                              .length ==
                                                                              0)
                                                                            ...
                                                                            function (
                                                                              ...
                                                                              if (
                                                                                ...
                                                                                if (
                                                                                            ...
                                                                                            filter_json_result:
                                                                                              {
                                                                                                ...
                                                                                                responsekey:
                                                                                                  msgtext[0]
                                                                                                    .messagekey,
                                                                                                response:
                                                                                                  varconstant.successresponsecode,
                                                                                                skill_list:
                                                                                                  skillresult,
                                                                                                state_list:
                                                                                                  locationresult.statelist,
                                                                                                district_list:
                                                                                                  Fulllocationresult.districtlist,
                                                                                                taluk_list:
                                                                                                  Fulllocationresult.taluklist,
                                                                                                jobfunctionlist:
                                                                                                  jobfunctionresult,
                                                                                                jobtypelist:
                                                                                                  jobtyperesult,
                                                                                  ...
                                                                                  objLocationFilter.getEmployeeSpecificTalukFilterBind(
                                                                                    logparams,
                                                                                    empparams,
                                                                                    function (
                                                                                      specifictaluklist
            ...
            objLocationFilter.getProfileLocationFilterBind(
              ...
              function (locationresult) {
                ...
                if (locationresult != null) {
                  if (
                    (locationresult.districtlist &&
                      locationresult.districtlist.length == 0) ||
                    (locationresult.taluklist &&
                      locationresult.taluklist.length == 0)
                  ) {
                    objLocationFilter.getLocationFilterBind(
                      logparams,
                      empparams,
                      function (Fulllocationresult) {
                        if (Fulllocationresult != null) {
                          ...
                          if (
                            ...
                            const msgparam = {
                              messagecode: varconstant.listcode,
                            };
                            objUtilities.getMessageDetailWithkeys(
                              msgparam,
                              function (msgtext) {
                    ...
                    function (msgtext) {
                      ...
                      return res.status(200).json({
                        education_filter_json_result: {
                          ...
                          schoolinglist: educationresult.schoolinglist,
                          afterschoolinglist:
                            educationresult.afterschoolinglist,
                        },
                      });
                    }
                  );
