...
exports.getInvitedJobList = async function (req, res) {
  try {
    ...
    objUtilities.CheckValidUserOrEmployeeOrEmployer(req, function (validemp) {
      if (validemp == true) {
        ...
        if (Number(req.query.sortbycode) == 1)
          ...
          sortbyparams = { "_id.matchpercentage": -1, "_id.jobcode": -1 };
        else sortbyparams = { "_id.approveddate": -1, "_id.jobcode": -1 };
        var empparams = {
        ...
        if (Object.keys(req.body).length > 0) {
          ...
          listparams = {
            ...
            jobtypecode: req.body.jobtypecode,
            schoolqualcode: req.body.schoolqualcode,
            afterschoolcatecode: req.body.afterschoolcatecode,
            afterschoolqualcode: req.body.afterschoolqualcode,
            afterschoolspeccode: req.body.afterschoolspeccode,
            experiencecode: req.body.experiencecode,
            employertypecode: req.body.employertypecode,
            companytypecode: req.body.companytypecode,
            maritalcode: req.body.maritalcode,
            ...
            anyage: req.body.anyage,
            anydegree: req.body.anydegree,
          };
          ...
          listparams = {
            ...
            maritalcode: [],
            gendercode: [],
            differentlyabled: varconstant.defaultdifferentlyabled,
            salaryfrom: 0,
            salaryto: 0,
            agefrom: 0,
            ageto: 0,
    ...
    logger.error("Error in Invited Job List: " + e);
  }
};
exports.InvitationAccepted = async function (req, res) {
  try {
      ...
      function (validemp) {
        if (validemp == true) {
          ...
          var params = {
            ipaddress: req.query.deviceip,
            usercode: logUserCode,
            orginator: "Job Invitation Accepted",
            type: logType,
          };
          objUtilities.getLogDetails(params, function (logresponse) {
            objLogdetails = logresponse;
                ...
                objInvitedList.ShortlistCount(
                  ...
                  function (employercount) {
                    ...
                    if (totalcount > 0 || jobcount == 0) {
                      objInvitedList.InvitationAcceptedSave(
                        logparams,
                        saveparams,
                        type,
                        function (jobresult) {
                          ...
                          if (jobresult != null && jobresult != "") {
                            ...
                            if (type == 1) {
                              var jobdetails = {
                                makerid: jobresult,
                                jobid: "JP" + req.query.jobcode,
                              };
                              objUtilities.FindEmployerMailID(
                                ...
                                function (result) {
                                  var empparams1 = {
                                    ...
                                    employeecode: 0,
                                    languagecode:
                                      varconstant.defaultlanguagecode,
                                    statuscode: [0],
                                  };
                                      ...
                                      objProfile.getProfileView(
                                        ...
                                        function (prefresult) {
                                          ...
                                          var registered_email =
                                            result[0].registered_email;
                                          //var adminmailid = mailid;

                                          const msgparam = {
                                            messagecode:
                                              varconstant.invitationacceptedcode,
                                          };
                                          objUtilities.getMessageDetailWithkeys(
                                            msgparam,
                                            function (msgresult) {
                                          ...
                                          objUtilities.GetAdminMailId(
                                            varconstant.admincode,
                                            function (mailid) {
                                          ...
                                          objSendNotification.SendInvitationAcceptedNotification(
                                            logparams,
                                            req,
                                            jobviewresult[0],
                                            prefresult,
                              ...
                              const msgparam = {
                                messagecode: varconstant.rejectedcode,
                              };
                              objUtilities.getMessageDetailWithkeys(
                                msgparam,
                                function (msgresult) {
                            ...
                            objUtilities.getMessageDetailWithkeys(
                              ...
                              function (msgresult) {
                                return res.status(200).json({
                                  job_json_result: {
                                    varstatuscode:
                                      varconstant.recordnotfoundcode,
                                    response: varconstant.successresponsecode,
                                    responsestring: msgresult[0].messagetext,
                                    responsekey: msgresult[0].messagekey,
                                  },
                      ...
                      const msgparam = {
                        messagecode: varconstant.shortlistexceedcode,
                      };
                      objUtilities.getMessageDetailWithkeys(
                        msgparam,
                        function (msgresult) {
    ...
    logger.error("Error in Invitation Accepted: " + e);
  }
};
