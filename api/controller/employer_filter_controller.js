...
exports.getEmployerFilterBind = async function (req, res) {
  try {
        ...
        if (Number(req.query.type) == 0) {
          objSkillFilter.getSkillFilterBind(logparams, empparams, function (skillresult) {
            if (skillresult != null && skillresult.length > 0) {
              ...
              objLocationFilter.getEmployerLocationFilterBind(logparams, empparams, function (locationresult) {
                if (locationresult != null) {
                  // //console.log(locationresult)
                  objJobFunctionFilter.getEmployerJobFunctionFilterBind(logparams, empparams, function (jobfunctionresult) {
                                            ...
                                            if (companytyperesult != null ) {
                                              objJobGroupFilter.getJobGroupFilterBind(logparams, empparams, function (jobgroupresult) {
                                                if (jobgroupresult != null) {
                                                  ...
                                                  objJobRoleFilter.getEmployerJobRoleFilterBind(logparams, empparams, function (jobroleresult) {
                                                    ////console.log(jobfunctionresult);
