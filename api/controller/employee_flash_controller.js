        ...
        if (Object.keys(req.body).length > 0) {
          objRecommendedJobList.getAllProfileConditions(logparams, empparams, function (profileresult) {
            listparams = {
              ...
              "locationcode": (req.body.locationcode.length > 0 ? req.body.locationcode : []),
            ...
            objJobList.getAllJobListTotal(logparams, empparams, listparams, 8, function (jobresulttotal) {
          ...
          objRecommendedJobList.getAllProfileConditions(logparams, empparams, function (profileresult) {
            listparams = { "industrycode": profileresult.industrycode, "jobrolecode": [], "jobfunctioncode": profileresult.jobfunctioncode, "skillcode": [], "locationcode": [], "jobtypecode": profileresult.jobtypecode, 
